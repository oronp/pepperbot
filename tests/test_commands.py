...
from pepperbot.providers.openai_codex_provider import _strip_model_prefix
from pepperbot.providers.registry import find_by_model
...
def test_onboard_fresh_install(mock_paths):
    ...
    assert "pepperbot is ready" in result.stdout
